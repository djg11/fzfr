#!/usr/bin/env python3
"""
generate_examples.py — Generate the remotely examples directory.
...
if __name__ == "__main__":
    ...
    make_tricky()
    make_readme()
    print("\nDone. Run: remotely local examples")
